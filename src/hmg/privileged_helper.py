...
def serve(port: int, token_path: Path, ttl_seconds: int, parent_pid: int) -> int:
    ...
    try:
        ...
        while time.monotonic() - started_at < ttl_seconds and _parent_is_alive(parent_pid):
...
def main(arguments: list[str] | None = None) -> int:
    ...
    try:
        ...
        return 2
    return serve(port, token_path, ttl_seconds, parent_pid)
